        ...
        <ul id="nav">
            <!--  管理员菜单
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a _href="user-list.html"> <i class="iconfont">&#xe6a7;</i>
                                                <cite>用户管理</cite> </a>
                                        </li>
                                        <li>
            ...
            <!-- 主管菜单-->
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a _href="/task-list"> <i class="iconfont">&#xe6a7;</i>
                                                <cite>查看任务</cite> </a>
                                        </li>
                                        <li>
                                            <a _href="/task-add"> <i class="iconfont">&#xe6a7;</i>
                                                <cite>制定任务</cite> </a>
                                        </li>
                                        <li>
                                            <a _href="/task-update"> <i class="iconfont">&#xe6a7;</i>
                                                <cite>调整任务</cite> </a>
                                        </li>
                                        <li>
                                            <a _href="/task-track"> <i class="iconfont">&#xe6a7;</i>
                                                <cite>跟踪任务</cite> </a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a _href="/emp-list"> <i class="iconfont">&#xe6a7;</i>
                                                <cite>查看人员</cite> </a>
                                        </li>
